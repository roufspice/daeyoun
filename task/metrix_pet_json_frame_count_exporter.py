...
#     """축종 세이브"""
#     # metadata_path = os.path.join(settings.EXPORT_ROOT, 'metrix_pet/통계/데이터메이커 구축량 현황.xlsx')
...
#         with open(os.path.join(export_path, 'json_build_amounts_1230.xlsx'), 'wb') as f:
