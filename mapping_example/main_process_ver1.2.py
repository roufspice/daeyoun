...
'''
이슈사항: 디렉토리내 동일한 파일명이 존재하는 에러 발생
해결사항: hash으로 변경 후 순서대로 재 정렬 
'''
data_list = []
data_dict = {}
